...
// marked v14: use marked.use() — the old new marked.Renderer() + setOptions path
// no longer applies custom renderers reliably.
marked.use({
	gfm: true,
	breaks: true,
	renderer: {
...
export function renderMarkdown(text: string): string {
	...
	try {
		// Pass async:false to guarantee a synchronous string return in marked v14
