						...
						<div class="mt-3 max-w-xs mx-auto">
							...
							{:else}
								<a
									...
									class="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all hover:opacity-90"
									style="background-color: var(--content); color: var(--surface); border: 1px solid var(--content)"
								>
